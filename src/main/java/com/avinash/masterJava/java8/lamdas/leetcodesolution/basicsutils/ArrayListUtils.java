...
public class ArrayListUtils {
    ...
    public static void main(String[] args) {
        ...
        Arrays.sort(tuples);
        log.info("Tuples sorted using Comparable: {}" , Arrays.toString(tuples));
        ...
        log.info("Tuples sorted using Comparator (Lambda): {}" , Arrays.toString(tuples1));
    }
}
